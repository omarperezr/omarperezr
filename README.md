...
Senior Backend Developer (7+ yrs) building high-throughput backend systems, APIs, and distributed
data infrastructure. Focused on Python and Go, with deep experience in search infra (Elasticsearch),
trading/fintech systems, and cloud-native deployments (GCP, AWS).

- 🔭 Currently: open to Senior Backend / Software Developer roles
- 🛠 Stack: Python · Go · C/C++ · FastAPI · Flask · Django · Docker · Kubernetes · PostgreSQL · Redis · Elasticsearch · Kafka
- ☁️ Cloud: GCP (Cloud Run, BigQuery, Cloud SQL) · AWS (S3, DynamoDB)
